...
var AddcartdetailsComponent = /** @class */ (function () {
    function AddcartdetailsComponent(shoppingservice, router) {
    ...
    AddcartdetailsComponent.prototype.ngOnInit = function () {
        this.productDetails = JSON.parse(localStorage.getItem("userProducts"));
        console.log(this.productDetails);
        this.calculate(this.productDetails);
    };
    AddcartdetailsComponent.prototype.changeItem = function (val, obj, i) {
        if (val == "dec") {
            obj.qty--;
            this.calculate(this.productDetails);
            if (obj.qty == 0) {
    ...
    AddcartdetailsComponent.prototype.removeItem = function (i) {
        this.productDetails.splice(i, 1);
        this.shoppingservice.addProductsToCart(this.productDetails);
        this.calculate(this.productDetails);
    };
    AddcartdetailsComponent.prototype.calculate = function (productDetails) {
        var _this = this;
        this.productCaculations = {
            totalPrice: 0,
            discount: 0,
        ...
        productDetails.map(function (product) {
            var priceAmount = product.price * product.qty;
            var discount = (product.discount * product.qty) * priceAmount / 100;
            _this.productCaculations.totalPrice += priceAmount;
            _this.productCaculations.discount += discount;
        });
    ...
    AddcartdetailsComponent.ctorParameters = function () { return [
    ...
    return AddcartdetailsComponent;
}());
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(shoppingservice, router) {
        this.shoppingservice = shoppingservice;
        this.router = router;
        this.allProducts = [];
    }
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.shoppingservice.productSendDetails.subscribe(function (products) {
            console.log(products);
            _this.allProducts = products;
        });
        this.shoppingservice.removeItem.subscribe(function (id) {
            console.log(id);
            _this.allProducts.splice(id, 1);
        });
    };
    HeaderComponent.prototype.itemsInSearch = function () {
...
var ItemComponent = /** @class */ (function () {
    function ItemComponent(shoppingservice) {
        this.shoppingservice = shoppingservice;
        this.sendProduct = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ItemComponent.prototype.ngOnInit = function () { };
    ItemComponent.prototype.addToCart = function (product) {
...
var ShoppingcartService = /** @class */ (function () {
    ...
    ShoppingcartService.prototype.addProductsToCart = function (products) {
        this.productSendDetails.next(products);
    };
    ShoppingcartService.prototype.searchDetails = function (event) {
        this.itemSearch.next(event);
    };
    ShoppingcartService.prototype.removeItemfromCart = function (id) {
...
var ShoppinglistComponent = /** @class */ (function () {
    function ShoppinglistComponent(shoppingcartService) {
    ...
    ShoppinglistComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.getProducts();
        this.shoppingcartService.itemSearch.subscribe(function (value) {
            _this.searchInfoDetails = value;
        });
    };
    ShoppinglistComponent.prototype.getProducts = function () {
        ...
        if (productDetails == null) {
            this.shoppingcartService.getProducts().subscribe(function (response) {
                // console.log(response);
                _this.shoppingDetails = response;
                localStorage.setItem("productDetails", JSON.stringify(_this.shoppingDetails));
            });
        }
        this.shoppingDetails = productDetails;
    };
    ShoppinglistComponent.prototype.getProduct = function (product) {
        if (!product.qty) {
            product.qty = 1;
        }
        if (this.allProducts.length == 0) {
            ...
            var isExist_1 = false;
            this.allProducts.map(function (prod) {
...
var ProductsearchPipe = /** @class */ (function () {
    ...
    ProductsearchPipe.prototype.transform = function (value) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        if (args[0]) {
            var searchStr_1 = args[0];
            var filteredItems = value.filter(function (obj) {
                console.log(searchStr_1.toLowerCase());
                return obj.name.toLowerCase().indexOf(searchStr_1.toLowerCase()) > -1 || obj.category.toLowerCase().indexOf(searchStr_1.toLowerCase()) > -1;
            });
